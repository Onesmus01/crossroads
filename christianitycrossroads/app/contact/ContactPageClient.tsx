...
export default function ContactPageClient() {
  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900">
            ...
            >
              <address className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-stone-200 space-y-3 sm:space-y-4 not-italic">
                ...
                {contactInfo.map((item, index) => (
                  ...
                  >
                    <div
                      className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg ${item.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                    >
                      <item.icon className="w-4 h-4 sm:w-5 sm:h-5" aria-hidden="true" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className="text-xs sm:text-sm text-stone-500 mb-0.5">
                        {item.label}
                      </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
                    <div className="space-y-1.5 sm:space-y-2">
                      <label
                        htmlFor="name"
                        className="text-xs sm:text-sm font-medium text-stone-700 ml-1"
                      >
                        Full Name
                      </label>
                      <input
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <ChevronDown
                        className="absolute right-3.5 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-stone-400 pointer-events-none"
                        aria-hidden="true"
                      />
                    </div>
                  </div>
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        <span className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white/20 flex items-center justify-center text-xs">
                          ✓
                        </span>
      ...
      {/* Map Placeholder */}
      <section
        className="px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20"
        aria-label="Ministry location map"
      >
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              <MapPin
                className="w-8 h-8 sm:w-12 sm:h-12 text-stone-500 mx-auto mb-2 sm:mb-3"
                aria-hidden="true"
              />
